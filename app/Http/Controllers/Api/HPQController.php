    ...
    public function show($code_hpq)
    {
        try {
            ...
            $data = [
                ...
                'notes' => $hpq->notes,
                'status' => $hpq->status,
                'fragrance_aroma_notes' => $hpq->fragrance_aroma_notes,
                'flavor_aftertaste_notes' => $hpq->flavor_aftertaste_notes,
                'acidity_mouthfeel_other_notes' => $hpq->acidity_mouthfeel_other_notes,
                'updated_at' => $hpq->updated_at,
                'score_summary' => $hpq->score_summary,
